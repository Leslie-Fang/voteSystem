...
!function (e) {
  ...
  (function (t) {
    function r(e) {
      ...
      var n,
          ...
          o = S.getElement(e),
          a = S.getOwnerID(e);return a && (n = S.getDisplayName(a)), "production" !== t.env.NODE_ENV && g(o, "ReactComponentTreeHook: Missing React element for debugID %s when building stack", e), i(r, o && o._source, n);
    }var u,
        c,
        l,
        f,
      ...
      var w = {},
        ...
        S = { onSetChildren: function onSetChildren(e, n) {
        ...
        var t = S.getElement(e);return "string" == typeof t ? t : "number" == typeof t ? "" + t : null;
      }, getUpdateCount: function getUpdateCount(e) {
        var t = c(e);return t ? t.updateCount : 0;
      }, getRootIDs: h, getRegisteredIDs: f };e.exports = S;
  }).call(t, n(0));
}, function (e, t, n) {
  "use strict";
  (function (t) {
    ...
    function r(e, t) {
      ...
      var c,
        ...
        d()("function" == typeof a, "You must pass a component to the function returned by connect. Instead received " + JSON.stringify(a));var c = a.displayName || a.name || "Component",
            l = E(c),
            p = m({}, k, { getDisplayName: E, methodName: N, renderCountProp: O, shouldHandleStateChanges: S, storeKey: j, withRef: P, displayName: l, wrappedComponentName: c, WrappedComponent: a }),
            v = function (e) {
          function c(t, n) {
          ...
          this.version !== R && (this.version = R, this.initSelector(), this.subscription && this.subscription.tryUnsubscribe(), this.initSubscription(), S && this.subscription.trySubscribe());
        }), f()(v, a);
      };
    }var l = n(38),
        f = n.n(l),
  ...
  var r, o;!function (t, n) {
    ...
    function a(e, t) {
      ...
      function t(e, t, n, r) {
        ...
        for (var t, n, r, o = e.length, i = E.relative[e[0].type], a = i || E.relative[" "], s = i ? 1 : 0, u = p(function (e) {
          ...
          var o = !i && (r || n !== S) || ((t = n).nodeType ? u(e, n, r) : c(e, n, r));return t = null, o;
        }]; s < o; s++) {
        ...
        var o = n.length > 0,
          ...
          var l,
              ...
              w = b.length;for (c && (S = _a === P || _a || c); h !== w && null != (l = b[h]); h++) {
            if (i && l) {
        ...
        var t,
          ...
          if (e === t) return j = !0, 0;var n = !e.compareDocumentPosition - !t.compareDocumentPosition;return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === P || e.ownerDocument === V && M(V, e) ? -1 : t === P || t.ownerDocument === V && M(V, t) ? 1 : D ? J(D, e) - J(D, t) : 0 : 4 & n ? -1 : 1);
        } : function (e, t) {
          if (e === t) return j = !0, 0;var n,
              ...
              i = t.parentNode,
              s = [e],
              u = [t];if (!o || !i) return e === P ? -1 : t === P ? 1 : o ? -1 : i ? 1 : D ? J(D, e) - J(D, t) : 0;if (o === i) return a(e, t);for (n = e; n = n.parentNode;) {
            s.unshift(n);
        ...
        var t,
            n = [],
            r = 0,
            o = 0;if (j = !x.detectDuplicates, D = !x.sortStable && e.slice(0), e.sort($), j) {
          for (; t = e[o++];) {
            t === e[o] && (r = n.push(o));
          }for (; r--;) {
            e.splice(n[r], 1);
      ...
      var r = t[0];return n && (e = ":not(" + e + ")"), 1 === t.length && 1 === r.nodeType ? ge.find.matchesSelector(r, e) ? [r] : [] : ge.find.matches(e, ge.grep(t, function (e) {
        ...
        Se = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(ge.fn.init = function (e, t, n) {
      var r, o;if (!e) return this;if (n = n || Ce, "string" == typeof e) {
        if (!(r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : Se.exec(e)) || !r[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);if (r[1]) {
    ...
    }).prototype = ge.fn, Ce = ge(ae);var De = /^(?:parents|prev(?:Until|All))/,
      ...
      ge.fn[e] = function (n, r) {
        var o = ge.map(this, t, n);return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = ge.filter(r, o)), this.length > 1 && (je[e] || ge.uniqueSort(o), De.test(e) && o.reverse()), this.pushStack(o);
      };
      ...
      var t;if (!e || "string" != typeof e) return null;try {
        ...
        St = /^(?:input|select|textarea|keygen)/i;ge.param = function (e, t) {
      var n,
          r = [],
          o = function o(e, t) {
        ...
        return this.map(function () {
          ...
          var e = this.type;return this.name && !ge(this).is(":disabled") && St.test(this.nodeName) && !Ct.test(e) && (this.checked || !$e.test(e));
        }).map(function (e, t) {
  ...
  function r(e, t) {
    ...
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      var u = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          S = o(a, g, "mergeProps");return n(x, p({ methodName: "connect", getDisplayName: function getDisplayName(e) {
          return "Connect(" + e + ")";
        }, shouldHandleStateChanges: Boolean(e), initMapStateToProps: O, initMapDispatchToProps: C, initMergeProps: S, pure: l, areStatesEqual: d, areOwnPropsEqual: m, areStatePropsEqual: E, areMergedPropsEqual: N }, T));
    };
  }();
}, function (e, t, n) {
  "use strict";
  ...
  (function (t) {
    function r(e) {
      ...
      for (var t = e.__reactAutoBindPairs, n = 0; n < t.length; n += 2) {
        ...
        S = function S() {};h(S.prototype, y.prototype, C);var D = { createClass: function createClass(e) {
      ...
      var m = typeof e === "undefined" ? "undefined" : _typeof(e);if ("undefined" !== m && "boolean" !== m || (e = null), null === e || "string" === m || "number" === m || "object" === m && e.$$typeof === u) return i(v, e, "" === n ? d + r(e, 0) : n), 1;var g,
        ...
        var N = c(e);if (N) {
          var T,
            ...
            if ("production" !== t.env.NODE_ENV) {
              var S = "";if (s.current) {
                var D = s.current.getName();D && (S = " Check the render method of `" + D + "`.");
              }"production" !== t.env.NODE_ENV && p(y, "Using Maps as children is not yet fully supported. It is an experimental feature that might be removed. Convert it to a sequence / iterable of keyed ReactElements instead.%s", S), y = !0;
            }for (; !(T = O.next()).done;) {
  ...
  function r(e, t) {
    ...
    return (0, l.bindActionCreators)({ changeItem: f.changeItem, submitSelectItem: f.submitSelectItem, submitTureItem: f.submitTureItem }, e);
    ...
    function e(e, t) {
      ...
      p = function (e) {
    function t(e) {
      r(this, t);var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)),
          i = n.props.items.filter(function (e) {
        return e.initChecked !== !1;
      });return n.state = { select: i[0].id }, n.handleChange = n.handleChange.bind(n), n.handleSubmit = n.handleSubmit.bind(n), n;
    }return i(t, e), u(t, [{ key: "handleChange", value: function value(e) {
        console.log(e.target.checked), console.log(e.target.id), this.setState({ select: e.target.id }, function () {
          console.log(this.state.select);
        });
      } }, { key: "handleSubmit", value: function value(e) {
        e.preventDefault(), console.log("submit");var t = this.state.select;console.log(t), (0, f.submitSelectItem)(t, function (e) {
          console.log(e), "fail" == e.queryVoted ? (console.log("Ready to submit data!"), (0, f.submitTureItem)(t)) : alert("Already Voted!");
        });
      } }, { key: "render", value: function value() {
        var e = this;return React.createElement("div", null, React.createElement("ul", { className: "list-unstyled" }, this.props.items.map(function (t, n) {
          return React.createElement("div", null, React.createElement("li", { key: t.id }, React.createElement("div", { className: "radio" }, React.createElement("label", null, React.createElement("input", { type: "radio", name: "radio", id: t.id, index: t.id, defaultChecked: t.initChecked, onChange: e.handleChange }), " ", t.name)), React.createElement("img", { src: t.link, className: "img-responsive", alt: "Logo" }), React.createElement("br", null), React.createElement("br", null)));
        })), React.createElement("div", { className: "text-center" }, React.createElement("button", { className: "btn btn-primary", onClick: this.handleSubmit }, "提交")));
      } }]), t;
  ...
  function r(e, t) {
    ...
    function t(e) {
      return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
        ...
        return React.createElement("div", null, React.createElement("h1", { className: "text-center" }, "投票通道"), React.createElement("br", null));
      } }]), t;
  }(React.Component),
      p = function (e) {
    function t(e) {
